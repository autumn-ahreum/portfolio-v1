      ...
      <div className='dev-section mt-3' id="dev-section">
        <div className='left-content mb-8 px-4 md:w-[70%] md:float-left'>
          ...
          <img
            ...
            alt="Ahreum Image"
          />
          <p className='font-lato font-light tracking-wide text-[15px] leading-6 sm:text-[18px] sm:leading-7 mt-4'>I’m Ahreum Han. A Design Engineer bridging the gap between aesthetic branding and functional code. I believe that visual beauty truly shines when it translates into seamless usability. My journey as a creator is not limited to a single role; I build brand identities that resonate, design intuitive UI/UX flows that guide users, and transform those visions into high-performance reality through frontend development. I strive to create digital products that are not only pixel-perfect but also robust and user-centered at their core.<br /><br />Before transitioning into the tech industry, I spent nearly a decade as a documentary broadcaster, mastering the art of audience-focused communication. This experience serves as the foundation of my work as a Design Engineer. Just as a documentary requires a clear flow and engaging delivery to keep viewers tuned in, a digital product requires seamless UX and robust performance. I leverage my deep understanding of human perspective to bridge the gap between complex backend logic and user-friendly frontend experiences.</p>
        </div>
